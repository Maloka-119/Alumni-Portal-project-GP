...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      console.log('Note: Could not update existing posts:', error.message);
    }
    ...
    // Remove the old category ENUM column if it exists
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      console.log('Note: Could not update posts:', error.message);
    }
