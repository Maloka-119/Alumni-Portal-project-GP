...
function GraduatedProfile() {
  ...
  const { t, i18n } = useTranslation(); // أضفنا i18n لمعرفة اتجاه الصفحة (RTL/LTR)
  ...
  // دالة مساعدة لضبط اتجاه التنبيه (من اليمين لليسار في العربي)
  ...
  const handlePhotoChange = (e) => {
    ...
    if (!validExtensions.includes(file.type)) {
      // تنبيه نوع الصورة مترجم ومتناسق الاتجاه
      Swal.fire({
        icon: "error",
        title: isRtl ? "عذراً" : "Sorry",
        text: isRtl ? "مسموح فقط بصور من نوع JPG" : "Only JPG images are allowed",
  ...
  // تنبيه حذف الصورة الشخصية مترجم بالكامل
  const handleRemoveProfilePicture = () => {
    Swal.fire({
      title: isRtl ? "هل أنت متأكد؟" : "Are you sure?",
      text: isRtl ? "سيتم حذف الصورة الشخصية الحالية" : "The current profile photo will be removed",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          ...
          text: isRtl ? "تم حذف الصورة الشخصية بنجاح" : "Profile photo removed successfully",
          timer: 2000,
  ...
  // تنبيه حذف الـ CV مترجم بالكامل (المطلوب في الصورة)
  const handleRemoveCv = () => {
    Swal.fire({
      title: isRtl ? "هل أنت متأكد؟" : "Are you sure?",
      text: isRtl ? "سيتم حذف السيرة الذاتية الحالية" : "The current CV will be removed",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#d33",
      cancelButtonColor: "#3085d6",
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          icon: "success",
          title: isRtl ? "تم الحذف" : "Deleted",
          text: isRtl ? "تم حذف السيرة الذاتية بنجاح" : "CV removed successfully",
          timer: 2000,
          showConfirmButton: false
        });
      }
  ...
  const handleSave = async () => {
    try {
      ...
      Swal.fire({
        ...
        text: isRtl ? "فشل في تحديث البيانات" : "Failed to update profile",
      });
    }
  };
