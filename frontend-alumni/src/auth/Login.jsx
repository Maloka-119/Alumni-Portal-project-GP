    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        if (provider === "linkedin") {
          ...
          fetch(`/alumni-portal/auth/linkedin?nationalId=${nationalId}`)
            .then(res => res.json())
            .then(data => {
          ...
          window.location.href = `/alumni-portal/auth/google?nationalId=${nationalId}`;
        }
      }
    });
  }
...
const handleGoogleLogin = async () => {
  try {
    ...
    window.open("/alumni-portal/auth/google", "_self");
  } catch (err) {
    Swal.fire({
      icon: "error",
      title: "Error",
...
const handleLinkedInLogin = async () => {
  try {
    ...
    const res = await fetch(`/alumni-portal/auth/linkedin`);
